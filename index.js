...
app.use(express.urlencoded({ extended: false })); // ativando bory-parses...
app.use(express.json()); //leitura de dados enviados via json...
...
//npm install moment --save - Fomatar data vinda do banco...
